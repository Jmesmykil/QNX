...
### Post-1.0 companion apps

The upstream Java uScreen (USB screen viewer) and WASM uDesigner (theme editor) are dead tools.
Native replacements are planned after v1.0.0 ships. Design notes live in
`docs/UPSTREAM-COMPANION-APPS-STRATEGY.md`. These are not in scope for the v1.2.3 release.
