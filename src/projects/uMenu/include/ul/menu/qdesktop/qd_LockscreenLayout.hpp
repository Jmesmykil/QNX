...
///   g_MenuApplication->LoadMenu(MenuType::QLockscreen);
class QdLockscreenLayout : public ul::menu::ui::IMenuLayout {
public:
    ...
    // Lockscreen has no per-layout sfx — intentional no-ops; not stubs.
