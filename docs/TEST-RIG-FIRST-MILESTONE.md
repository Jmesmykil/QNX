...
`/Users/astral/QOS/tools/switch-nro-harness/src/main.rs` that:
...
```bash
cd /Users/astral/QOS/tools/switch-nro-harness
...
```bash
python3 /Users/astral/QOS/tools/qos-ulaunch-fork/tools/test-rig/mac-bridge.py ping
```
