...
#include <ul/menu/qdesktop/qd_Theme.hpp>  // v2.6.0 — overlay + gutter bg read g_QdTheme
                             ...
                             const s32 origin_x, const s32 origin_y)
{
    ...
    // v2.6.0 — theme-aware: was hardcoded #080812.
    SDL_SetRenderDrawBlendMode(r, SDL_BLENDMODE_BLEND);
    {
        const auto &db = ::ul::menu::qdesktop::g_QdTheme.desktop_bg;
        SDL_SetRenderDrawColor(r, db.r, db.g, db.b, 0xF0u);
    }
    ...
    // v2.6.0 — theme-aware: was hardcoded surface_glass-ish navy.
    SDL_SetRenderDrawBlendMode(r, SDL_BLENDMODE_BLEND);
    {
        const auto &sg = ::ul::menu::qdesktop::g_QdTheme.surface_glass;
        SDL_SetRenderDrawColor(r, sg.r, sg.g, sg.b, 0xE0u);
    }
