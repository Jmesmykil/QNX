...
namespace ul::menu::ui {
    ...
    class EntryMenu : public pu::ui::elm::Element {
        ...
        private:
            ...
            // Layer 3: per-tile dirty flag set by FlushIconCache(); cleared on first
            // successful SDL_CreateTexture so icons are uploaded one-per-frame, not in a burst.
            std::vector<bool> entry_icon_dirty;
