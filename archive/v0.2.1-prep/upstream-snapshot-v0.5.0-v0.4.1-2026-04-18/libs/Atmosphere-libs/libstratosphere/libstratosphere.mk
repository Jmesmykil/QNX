...
#---------------------------------------------------------------------------------
ifeq ($(ATMOSPHERE_BOARD),nx-hac-001)
# QOS-fork: /opt/homebrew added to pick up jpeglib.h when portlibs are absent (2026-04-18)
LIBDIRS	:= $(PORTLIBS) $(LIBNX) $(ATMOSPHERE_LIBDIRS) $(ATMOSPHERE_LIBRARIES_DIR)/libvapours /opt/homebrew
else
