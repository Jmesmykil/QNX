...
// Drop the cached per-theme hot-corner Q glyph and re-arm its one-shot loader so
// it re-loads HotCornerQ.png from the active theme on the next overlay paint.
// Call on a live theme switch (the texture is otherwise sticky for the process).
