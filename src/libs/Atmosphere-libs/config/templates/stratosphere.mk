...
# QOS-fork: inject Homebrew libjpeg-turbo headers for missing portlibs (2026-04-18)
export ATMOSPHERE_CXXFLAGS += -I/opt/homebrew/include
export ATMOSPHERE_CFLAGS   += -I/opt/homebrew/include
else
export LIBDIRS	=
endif
