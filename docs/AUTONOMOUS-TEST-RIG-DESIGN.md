...
2.  Build uMenu.nso:
        cd /Users/astral/QOS/tools/qos-ulaunch-fork/src/projects/uMenu
        make -j$(nproc)
3.  Push to Switch:
        python3 tools/test-rig/mac-bridge.py push uMenu.nso
...
The existing harness at `/Users/astral/QOS/tools/switch-nro-harness/` is at **v1.0.2**
...
```bash
# Mount SD via UMS
cp /Users/astral/QOS/tools/qos-ulaunch-fork/staging/last-known-good.nso \
...
Step 3: PUSH
    python3 /Users/astral/QOS/tools/qos-ulaunch-fork/tools/test-rig/mac-bridge.py \
