...
// Q OS fork patch v0.2.1: dotfile filter added to UL_FS_FOR macro (QOS-PATCH-001).
#pragma once
#include <switch.h>
#include <sys/stat.h>
#include <dirent.h>
...
namespace ul::fs {
    ...
    // QOS-PATCH-001: Skip dotfiles/dot-directories (e.g. .Spotlight-V100, .Trash)
    // so Q OS launcher never renders macOS or system hidden entries as app icons.
