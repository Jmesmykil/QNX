...
- [ ] **1.1 License audit final**
  ...
  - What: Confirm `src/LICENSE` at repo root is unmodified GPLv2 full text (no edits, no
    ...
    `md5sum /Users/astral/QOS/tools/qos-ulaunch-fork/src/LICENSE`
...
- [ ] **1.3 Asset license file created under `assets/`**
  ...
  - Path: `/Users/astral/QOS/tools/qos-ulaunch-fork/assets/LICENSE-ASSETS.md`
...
- [ ] **2.2 `icon.png` (256×256 PNG) for hb-appstore ready**
  ...
  - What: Convert `assets/qos-icon-256.jpg` to PNG and place as `assets/icon.png`:
    ```
    sips -s format png /Users/astral/QOS/tools/qos-ulaunch-fork/assets/qos-icon-256.jpg \
         --out /Users/astral/QOS/tools/qos-ulaunch-fork/assets/icon.png
    ```
...
- [ ] **2.3 Screenshot `screen.png` (1280×720) captured and placed**
  ...
  - What: Boot Q OS uMenu on Switch (or Ryujinx), screenshot the desktop in QDESKTOP_MODE.
    ...
    sips -z 720 1280 /path/to/screenshot.png \
         --out /Users/astral/QOS/tools/qos-ulaunch-fork/assets/screen.png
    ```
...
- [ ] **4.1 Install / uninstall / recovery docs added to README.md**
  ...
  - Path: `/Users/astral/QOS/tools/qos-ulaunch-fork/README.md`
...
- [ ] **4.2 CONTRIBUTING.md created**
  ...
  - Path: `/Users/astral/QOS/tools/qos-ulaunch-fork/CONTRIBUTING.md`
...
- [x] **5.1 Makefile `package` target renamed to produce `qos-umenu-vX.Y.Z.zip`**
  ...
  - Path: `/Users/astral/QOS/tools/qos-ulaunch-fork/src/Makefile` line 9
...
- [ ] **5.2 `info.json` placed at package root for `repogen.py`**
  ...
  - What: Place the `info.json` from `docs/HBAPPSTORE-MANIFEST.md` section 1 at:
    `/Users/astral/QOS/tools/qos-ulaunch-fork/info.json`
...
- [ ] **5.3 `CREDITS.md` added to ZIP root (required by `UPSTREAM-ATTRIBUTION-COMMIT.md`)**
  ...
  - Path: `/Users/astral/QOS/tools/qos-ulaunch-fork/src/CREDITS.md`
...
- [ ] **6.1 Release branch/tag created**
  ...
  - What:
    ```
    git -C /Users/astral/QOS/tools/qos-ulaunch-fork tag -a qos-umenu-v3.0.2 \
        -m "Q OS uMenu v3.0.2 — public hard-fork release"
    git -C /Users/astral/QOS/tools/qos-ulaunch-fork push origin qos-umenu-v3.0.2
    ```
  - Status: Not yet tagged. Blocked on all Phase 1–5 items.

- [ ] **6.2 Build artifacts produced**
  - Who: Agent or CI (run `make -C /Users/astral/QOS/tools/qos-ulaunch-fork/src package`)
  - What: Produces `qos-umenu-v3.0.2.zip` (and `.7z`) in `src/`. Requires devkitPro/devkitA64
...
- [ ] **6.3 GitHub Release created with ZIP uploaded**
  ...
  - What:
    ```
    gh release create qos-umenu-v3.0.2 \
        /Users/astral/QOS/tools/qos-ulaunch-fork/src/qos-umenu-v3.0.2.zip \
        --repo Jmesmykil/QOS \
        --title "Q OS uMenu v3.0.2" \
        --notes-file /Users/astral/QOS/tools/qos-ulaunch-fork/docs/UPSTREAM-ATTRIBUTION-COMMIT.md
    ```
    Also attach `qos-umenu-v3.0.2.7z` for users who prefer 7-zip.
...
- [ ] **7.1 hb-appstore PR opened**
  ...
  - What: Open a PR or submit via web form at `https://hb-app.store/submit-or-request`.
    ...
    Attach: `icon.png` (256×256 PNG), `screen.png` (1280×720 PNG), `qos-umenu-v3.0.2.zip`,
    `info.json` (from `docs/HBAPPSTORE-MANIFEST.md` section 1).
    Link: https://github.com/Jmesmykil/QOS/releases/tag/qos-umenu-v3.0.2
...
- [ ] **8.1 Smoke-test fresh install on a clean SD card**
  ...
  - What: On a second SD card (or after backing up the current one):
    ...
    6. Run `uManager.nro` — confirm version string `v3.0.2` is shown.
...
- **Fix applied:** Changed to `OUT_DIR_ZIP := qos-umenu-v$(VERSION)` (line 9 only).
  ...
  Next `make package` will produce `qos-umenu-v3.0.2.zip` and `qos-umenu-v3.0.2.7z`.
